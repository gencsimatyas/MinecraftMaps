<?php
			...
			$sql = "SELECT  `category` ,`name`, `description`, `pic`, `size`, `downloadlink`, `downloads`, `author` FROM `maps` ORDER BY time desc limit 1, 20";
			...
			echo '<br/><hr/>';
			echo '<p class="iras6">New Maps</p>'; //atiras
